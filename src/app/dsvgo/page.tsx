    ...
    <div className="">
      ...
      <div className="max-w-[1024px] mx-auto p-4 space-y-4 mb-8">
        ...
        <div className="text-secondary text-lg md:text-xl space-y-4">
          ...
          <p>4.1 Geltungsbereich</p>
          <p>
            Die Datenschutz-Erklärung gilt für die Seite www.maag-consulting.com
            und die hierauf angebotenen Inhalte. Für weiterführende Links oder
            Partner-Unternehmen verliert dieser Datenschutz-Hinweis seine
            Gültigkeit. Die mc - maag consulting GmbH verpflichtet sich den
            Anforderungen der Datenschutz-Grundverordnung (EU-DSGVO).
          </p>
          <p>4.2 Verwendung personenbezogener Daten</p>
          <p>
            Personenbezogene Daten stellen einen Bezug zu Ihrer Person her. Das
            sind Angaben bzw. Daten wie z. B. Ihr Name (Vor- und Zuname), Ihre
            Anschrift, Ihre Telefonnummer oder Ihre persönliche E-Mail-Adresse.
            Wir verpflichten uns dem Grundsatz der Datenvermeidung und
            -sparsamkeit. Deshalb werden nur solche Daten erhoben, die für den
            gewünschten Zweck notwendig sind oder Sie uns freiwillig mitteilen.
            Notwendig sind personenbezogene Daten wenn Sie zu uns Kontakt
            aufnehmen über das Kontakt-Formular. Hier benötigen wir Ihren Namen
            und E-Mail-Adresse um Ihnen zu antworten. Weitere Angaben sind
            freiwillig.
          </p>
          <p>
            Die personenbezogenen Daten, die Sie uns mitteilen, werden nur zur
            Korrespondenz mit Ihnen verwendet. Ihre personenbezogenen Daten
            werden nicht an Dritte weitergegeben. Ihre übermittelten
            personenbezogenen Daten verwenden wir nur dann zu Werbezwecken, wenn
            Sie uns Ihre Einwilligung gegeben haben.
          </p>
          <p>4.3 Auskunft, Löschung, Sperrung</p>
          <p>
            Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre
            gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger
            und den Zweck der Datenverarbeitung sowie ein Recht auf
            Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu und auch
            bei Änderung, Löschung oder Widerruf zur Nutzung Ihrer
            personenbezogener Daten sowie zu weiteren Fragen zum Thema
            personenbezogene Daten können Sie sich jederzeit über die im
            Impressum angegeben Adresse an uns wenden.
          </p>
          <p>4.4 Sicherheit Ihrer Daten</p>
          <p>
            Ihre uns zur Verfügung gestellten personenbezogenen Daten werden mit
            dem aktuellen Stand der Technik geschützt und durch Zugriff
            Unberechtigter geschützt.
          </p>
          <p>4.5 Cookies</p>
          <p>
            Die Internetseiten und Server verwenden gegebenenfalls teilweise so
            genannte Cookies. Cookies richten auf Ihrem Rechner keinen Schaden
          ...
          <p>
            Viele Cookies enthalten eine sogenannte Cookie-ID. Eine Cookie-ID
          ...
          <p>4.6 Server-Log-Files</p>
          <p>
            Diese Seite erhebt und speichert automatisch Daten in sogenannten
            Server-Log-Files, die von Ihrem Browser an uns übermittelt werden.
            Diese Daten sind nicht personenbezogen und werden nicht mit anderen
            Datenquellen verknüpft. Erfasst werden: Datum + Uhrzeit der
            Serveranfrage, IP-Adresse, Browser + Betriebssystem des Rechners,
          ...
          <p>6. Änderungsvorbehalt</p>
          <p>
            Der Webseitenbetreiber dieser Seite behält es sich vor, die
            Datenschutzerklärung unter Beachtung geltender, gesetzlicher
            Bestimmungen anzupassen und zu ergänzen.
          </p>
